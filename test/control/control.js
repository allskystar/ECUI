...
test('getClass/getPrimary/getType/setClass', {
    '控件初始化后的样式': function () {
        var common = ecui.get('common'),
            parent = ecui.get('parent'),
            control = ecui.create(ecui.ui.Control, {primary: 'demo2', type: 'ec-demo2', parent: common});
        ...
        value_of(common.getType()).should_be('ui-control');
        value_of(parent.getType()).should_be('ui-control');
