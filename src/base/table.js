    ...
    ui.Table = core.inherits(
        ...
        function (el, options) {
            ...
            if (core.getScrollNarrow()) {
                dom.insertHTML(el, 'beforeEnd', '<div class="' + this.getUnitClass(ui.Table, 'layout-scrollbar') + '" style="overflow:auto"><div class="' + this.getUnitClass(ui.Table, 'layout-body') + '"></div></div>' + o);
                o = el.lastChild;
                o.previousSibling.appendChild(table);
                this._eLayout = o.previousSibling.previousSibling;
            } else {
                dom.insertHTML(el, 'beforeEnd', '<div class="' + this.getUnitClass(ui.Table, 'layout-touchpad') + '" style="overflow:hidden">' + o + '</div>');
