...
省市区三级联动：
<div ui="type:b-cities;multi:3"></div>
        ...
        },
        {
            ...
            getCity: function (code) {
                ...
                var pro = code.slice(0, 2) + '0000',
                    ...
                    area = code.slice(0, 6),
                    arr = [];
                arr.push(this.CITIES[pro]);
                if (code.slice(2, 4) !== '00') {
                    arr.push(this.CITIES[city] || '');
                }
                if (code.slice(4, 6) !== '00') {
                    arr.push(this.CITIES[area] || '');
                }
                return arr;
            },
