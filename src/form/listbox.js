    ...
    ui.Listbox = core.inherits(
        ...
        },
        {
            ...
            Item: core.inherits(
                ...
                function (el, options) {
                    _super(el, options);
                    el.insertAdjacentHTML('beforeEnd', '<input type="checkbox" class="ui-hide">');

                    this._eInput = el.lastChild;
                    el.lastChild.value = options.value === undefined ? el.textContent : options.value;
                ...
                },
                {
                     ...
                     */
                    getContent: function () {
                        return _super.getContent().slice(0, -this._eInput.outerHTML.length);
                    },
