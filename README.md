...
demo(项目目录)
           ...
           |_ _ _
                ...
                |     |
                |     |_ _ _  define_.js  --------  demo 目录下全局js，可用于路由加载
                |     |
                |     |_ _ _  define_.css  -------  demo 目录下全局css
                |     |
                ...
                |                  |               
                |                  |_ _ _ define_.js  -------------  demo子目录js
                |                  |               
                |                  |_ _ _ define_.css  ------------  demo子目录css
                |                  |               
...
- define_.js 为必要文件，框架根据该文件进行路由扫描，请勿更改文件名
...
- 步骤三：在同级目录的 define_.js 中调用 ecui.esr.loadRoute() 方法 加载该路由，代码如下：
